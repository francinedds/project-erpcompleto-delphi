...
begin
   ...
   try
     ...
     // valida e cria o arquivo .ini caso não exista
     ...
     // inicia novamente o arquivo de configuração
     LIniFile  := TIniFile.Create(LCaminho);
     LDatabase := LIniFile.ReadString('Conexao','Database', LDatabase); // lê string dentro do arquivo .ini
